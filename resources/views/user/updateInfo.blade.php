  ...
  <div class="container" style="padding-top: 100px;">
    <div class="row">
      ...
      <form action="{{url('updateInfo2',Auth::user()->id)}}" method="post" enctype="multipart/form-data">
        ...
        <div class="div-name">
          <label>Nombre</label>
          <input class="txt" type="text" name="name" value="{{Auth::user()->name}}" required="">
        </div>

        <div class="div-name">
          <label>Correo</label>
          <input class="txt" type="text" name="email" value="{{Auth::user()->email}}" required="">
        </div>

        <div class="div-name">
          <label>Teléfono</label>
          <input class="txt" type="text" name="phone" value="{{Auth::user()->phone}}" required="">
        </div>

        <div class="div-name">
          <label>Dirección</label>
          <input class="txt" type="text" name="address" value="{{Auth::user()->address}}" required="">
        </div>
